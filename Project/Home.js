...

{
  ...
  <Link to='/services'><img  src={bg3} className="abi2"/></Link>
   <CardBody>
  ...
  <div class="abi2">
  <Card body inverse color="success">
  <Link to='/services'><CardImg top width="80%" src={bg4} alt="card image cap"/></Link>
   <CardBody>
  ...
  <div className="abi2">
  <Card body inverse color="success">
  <Link to='/services'><CardImg top width="80%" src={bg5} alt="card image cap"/></Link>
   <CardBody>
  ...
  <div className="abi3">
  <Card body inverse color="success">
  <Link to='/services'><CardImg top width="80%" src={bg6} alt="card image cap"/></Link>
   <CardBody>
  ...
  <div className="abi2">
  <Card body inverse color="success">
  <Link to='/services'><CardImg top width="100%" src={bg7} alt="card image cap"/></Link>
   <CardBody>
  ...
  <div className="abi4">
  <Card body inverse color="success">
 <Link to='/services'> <CardImg top width="80%" src={bg8} alt="card image cap"/></Link>
   <CardBody>
...
<CardGroup>
  ...
  <img src={bg12} width={200} style={{'text-align':'center'}} className="abi1"/>
...
<Card body outline color="success">
  ...
  <img src={bg13} width={200} style={{'text-align':'center'}} className="abi1"/>
  ...
  <img src={bg14} width={200} style={{'text-align':'center'}} className="abi1"/>
  ...
  <img src={bg15} width={200} style={{'text-align':'center'}} className="abi1"/>
  ...
  <img src={bg16} width={200} style={{'text-align':'center'}} className="abi1"/>
  ...
  <img src={bg17} width={200} style={{'text-align':'center'}} className="abi1"/>
